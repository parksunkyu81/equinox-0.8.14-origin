...
HS_CURV_DELTA_MAX_BP = [30.0, 45.0, 55.0, 70.0, 90.0, 100.0, 110.0, 130.0]
HS_CURV_DELTA_MAX_V = [0.00100, 0.00072, 0.00048, 0.00042, 0.00030, 0.00022, 0.00017, 0.00013]

# desired_curvature_rate 절대값 제한
HS_CURV_RATE_MAX_BP = [30.0, 45.0, 55.0, 70.0, 90.0, 100.0, 110.0, 130.0]
HS_CURV_RATE_MAX_V = [0.030, 0.023, 0.014, 0.012, 0.0085, 0.0060, 0.0045, 0.0034]

# 저역통과 필터 alpha (작을수록 더 부드러움)
HS_CURV_ALPHA_BP = [30.0, 45.0, 55.0, 70.0, 90.0, 100.0, 110.0, 130.0]
HS_CURV_ALPHA_V = [0.58, 0.48, 0.36, 0.34, 0.27, 0.20, 0.16, 0.11]
...
STABLE_TORQUE_CURVE_RELIEF_V = [1.00, 1.00, 1.00, 0.96, 0.92]
...
DYN_LAT_FACTOR_V  = [1.88, 1.84, 1.82, 1.83, 1.84, 1.86, 1.88, 1.90, 1.93, 1.95, 2.10, 2.18, 2.25]  # v39: reduce 100kph+ highway weave
