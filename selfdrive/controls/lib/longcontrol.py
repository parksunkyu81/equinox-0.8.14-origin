...
class LongControl:
  ...
  def update(self, active, CS, long_plan, accel_limits, t_since_plan,
    ...
    # tracking objects and driving
      ...
      # When a previously visible lead has been absent for 0.1 s, the planner
      # marks a short one-shot clear-road recovery window.
      ...
      # the planner and this gate still requires a current lead-free plan.
