...
class nTune():
  ...
  def checkValidCommon(self):
    ...
    if self.checkValue("steerActuatorDelay", 0., 0.8, 0.05):
      updated = True
  ...
  def checkValidTorque(self):
    ...
    if self.checkValue("useSteeringAngle", 0., 1., 1.):
      updated = True
    if self.checkValue("latAccelFactor", 1.75, 2.42, 2.05):
      updated = True
    if self.checkValue("friction", 0.165, 0.305, 0.230):
      updated = True
  ...
  def checkValidSCC(self):
    ...
    if self.checkValue("sccCurvatureFactor", 0.5, 1.5, 0.87):
      updated = True
