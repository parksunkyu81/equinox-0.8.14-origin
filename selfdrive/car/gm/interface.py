...
class CarInterface(CarInterfaceBase):
    ...
    def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
        ...
        ret.longitudinalTuning.kpBP = [0., 30. * CV.KPH_TO_MS, 50. * CV.KPH_TO_MS, 60. * CV.KPH_TO_MS,
                                       80. * CV.KPH_TO_MS, 130. * CV.KPH_TO_MS]
        ret.longitudinalTuning.kpV = [0.85, 0.6, 0.55, 0.5, 0.45, 0.4]  # Reduced kpV values for smoother acceleration
        #ret.longitudinalTuning.kpV = [0.8, 0.74, 0.66, 0.61, 0.56, 0.51, 0.46, 0.42, 0.38]
        ret.longitudinalTuning.kiBP = [0., 25. * CV.KPH_TO_MS, 130. * CV.KPH_TO_MS]
