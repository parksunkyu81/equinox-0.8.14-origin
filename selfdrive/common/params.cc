...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"EquinoxSimGasPressed", CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_OFF},
    {"EquinoxSimIgnition", CLEAR_ON_MANAGER_START},
    {"EquinoxSimReset", CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_OFF},
    {"EquinoxSimTargetSpeedKph", CLEAR_ON_MANAGER_START},
    ...
    {"DynamicSteerDeltaMaxUp", PERSISTENT},
    {"DynamicSteerDeltaMaxDown", PERSISTENT},
    {"TorqueDirectionalCompEnabled", PERSISTENT},
    {"TorqueCenterOffsetEnabled", PERSISTENT},
    {"TorqueCenterOffset20_40", PERSISTENT},
    {"TorqueCenterOffset20_40Count", PERSISTENT},
    {"TorqueCenterOffset40_60", PERSISTENT},
    {"TorqueCenterOffset40_60Count", PERSISTENT},
    {"TorqueCenterOffset60_100", PERSISTENT},
    {"TorqueCenterOffset60_100Count", PERSISTENT},
    {"TorqueLowSpeedGainVersion", PERSISTENT},
    {"TorqueLowSpeedGain10_20", PERSISTENT},
    {"TorqueLowSpeedGain10_20Count", PERSISTENT},
    {"TorqueLowSpeedGain20_30", PERSISTENT},
    {"TorqueLowSpeedGain20_30Count", PERSISTENT},
    {"TorqueLowSpeedGain30_40", PERSISTENT},
    {"TorqueLowSpeedGain30_40Count", PERSISTENT},

    {"ManualLeadCatchupEnabled", PERSISTENT},
    {"ManualLeadCatchupMaxAccel", PERSISTENT},
