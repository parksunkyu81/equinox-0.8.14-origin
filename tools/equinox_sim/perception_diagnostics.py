  ...
  def _snapshot(self, now):
    ...
    return {
      ...
      "plan": {
        ...
        "pathStabilityActive": bool(plan.pathStabilityActive),
        "pathStabilityRangeM": rounded(plan.pathWobbleRangeM),
        "pathStabilityFlips": int(plan.pathWobbleFlips),
        "laneCenterCorrectionM": rounded(plan.laneCenterCorrectionM),
        "laneCenterCorrectionActive": bool(plan.laneCenterCorrectionActive),
      ...
      "control": {
        ...
        "dynamicTorque": {
          ...
          "responseScale": rounded(controls.dynamicTorqueResponseScale),
          "responseRatio": rounded(controls.dynamicTorqueResponseRatio),
          "responseBin": int(controls.dynamicTorqueResponseBin),
          "responseStable": bool(controls.dynamicTorqueResponseStable),
          "responseFrozen": bool(controls.dynamicTorqueResponseFrozen),
          "responseUpdateCount": int(controls.dynamicTorqueResponseUpdateCount),
          "pathStabilityActive": bool(controls.dynamicTorquePathStabilityActive),
          "pathWobbleRangeM": rounded(controls.dynamicTorquePathWobbleRange),
          "pathWobbleFlips": int(controls.dynamicTorquePathWobbleFlips),
          "laneCenterCorrectionM": rounded(controls.laneCenterCorrectionM),
          "laneCenterCorrectionActive": bool(controls.laneCenterCorrectionActive),
